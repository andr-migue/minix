...
\paragraph{A. Constantes de configuraci\'on.}
...
Esta es la funci\'on m\'as significativamente modificada. Se ejecuta cada 5 segundos y aplica la pol\'itica completa. El c\'odigo completo despu\'es de la modificaci\'on:

\begin{lstlisting}[style=cstyle,caption={Nueva l\'ogica de \texttt{balance\_queues()}}]
void balance_queues(void)
{
    ...
    for (proc_nr=0, rmp=schedproc; proc_nr < NR_PROCS; proc_nr++, rmp++) {
        ...
        if (rmp->flags & IN_USE && !is_system_proc(rmp)) {
            ...
            /* Rama: procesos de sistema (comportamiento original) */
